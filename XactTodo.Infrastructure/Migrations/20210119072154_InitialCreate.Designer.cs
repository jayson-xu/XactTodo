...
namespace XactTodo.Infrastructure.Migrations
{
    ...
    [Migration("20210119072154_InitialCreate")]
            ...
            modelBuilder.Entity("XactTodo.Domain.AggregatesModel.UserAggregate.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreationTime = new DateTime(2021, 1, 19, 0, 0, 0, 0, DateTimeKind.Local),
                            DisplayName = "管理员",
                            Email = "",
                            EmailConfirmed = false,
                            Password = "ANBit2mhhIvRwp0aCBBiYQwz0GruoKP9rF3tP04d+4SNQGVvgvL7QzPGfp2rqozifA==",
                            UserName = "admin"
                        });
                });
